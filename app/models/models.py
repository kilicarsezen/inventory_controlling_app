...
class Material(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    material_number = db.Column(db.Integer, unique=True, nullable=False)
    jpdm_number = db.Column(db.String(50), unique=True, nullable=True)
    sap_print_number = db.Column(db.String(50), unique=True, nullable=True)
    mw_code = db.Column(db.String(50), unique=True, nullable=True)
    wst_code = db.Column(db.String(50), unique=True, nullable=True)
